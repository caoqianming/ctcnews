...
def startdriver():
    firsturl = 'http://www.gsdata.cn/member/login'
    driver = webdriver.Firefox(firefox_binary = binary)
    driver.get(firsturl)
    time.sleep(2)
    driver.find_element_by_xpath('/html/body/div[2]/div/div[2]/div/a[2]/img').click()
    ...
    for i in list(data.keys()):
        ...
        for i in listsoup:
            ...
            if wxsj[0:10] == str(datetime.date.today() - datetime.timedelta(days = 1)):
                ...
                wxdetail = i.find('p').a.string
                wxzan = i.find('i',{'class':'icons1 icon1-praise'}).parent.get_text()
